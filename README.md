...
Current managed package: [PowerPagesWebApiFieldsAuditor_1_6_0_27_managed.zip](https://github.com/larsendn/power-pages-webapi-access-auditor/releases/download/v1.6.0.27/PowerPagesWebApiFieldsAuditor_1_6_0_27_managed.zip)
...
.\scripts\build-solution-packages.ps1 -Version 1.6.0.27 -SolutionId <solution-id>
```
