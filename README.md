...
Current managed package: [PowerPagesWebApiFieldsAuditor_1_6_0_17_managed.zip](https://github.com/larsendn/power-pages-webapi-access-auditor/releases/download/v1.6.0.17/PowerPagesWebApiFieldsAuditor_1_6_0_17_managed.zip)
...
.\scripts\build-solution-packages.ps1 -Version 1.6.0.17 -SolutionId <solution-id>
```
