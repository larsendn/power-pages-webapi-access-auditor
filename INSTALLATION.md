...
- [PowerPagesWebApiFieldsAuditor_1_6_0_23_managed.zip](https://github.com/larsendn/power-pages-webapi-access-auditor/releases/download/v1.6.0.23/PowerPagesWebApiFieldsAuditor_1_6_0_23_managed.zip)
...
The installed solution name is **Power Pages Web API Fields Auditor**. Version `1.6.0.23` contains one code app and seven cloud flows.
...
The lower-left sidebar shows the running app version. Confirm it displays **Version 1.6.0.23**.
